...
public class Cart {
    ...
    public static void cart(int numberOfItems){
        ...
        while(changeCart == 'y'){
            if(numberOfItems <= 0){
                ...
                for(int i = 0; i < numberOfItems; i++){
                    System.out.println("\t" + (i+1) + ". " + "$" + cart[i].dollarPrice + "." + cart[i].centPrice + " " + cart[i].name + " - " + descriptions[cart[i].ID].shortDescription + " Qty: " + cart[i].quantity);
                }
                ...
                if(changeCart == 'y'){
                    ...
                    itemNumber = Methods.checkNumber(1, numberOfItems);
                    while(itemNumber == -1){
                        System.out.print("Invalid selection! Please enter a number between 1 and " + numberOfItems + ": ");
                        itemNumber = Methods.checkNumber(1, numberOfItems);
                    }
                    ...
                    if(removeChange == 'c'){
                        ...
                        Arrays.sort(cart,0,numberOfItems);
                        numberOfItems--;
                    }
